...
const Achievements = {
  ...
  DATA: [
    ...
    {
      id: 'first-robot',
      icon: '🤖', title: 'Primer Programador',
      description: 'Completa tu primer nivel del Lab de Robots',
      category: 'robotics', trigger: 'run-robot', goal: 1
    },
    {
      id: 'robot-master',
      icon: '⚙️', title: 'Maestro Robótico',
      description: 'Completa los 3 niveles del Lab de Robots',
      category: 'robotics', trigger: 'run-robot', goal: 3
    },
    {
      id: 'bug-hunter',
      icon: '🐛', title: 'Cazador de Bugs',
      description: 'Encuentra 5 errores en el Debugging Lab',
      category: 'robotics', trigger: 'bugs-found', goal: 5
    },
    {
      id: 'master-debugger',
      icon: '🔧', title: 'Depurador Experto',
      description: 'Corrige los 3 desafíos del Debugging Lab',
      category: 'robotics', trigger: 'fix-debug', goal: 3
    },
    {
      id: 'automation-engineer',
      icon: '⚙️', title: 'Ingeniero de Automatización',
      description: 'Crea 3 o más reglas en el Automation Lab',
      category: 'robotics', trigger: 'automation-rules', goal: 3
    },
    {
      id: 'prompt-sniper',
      icon: '🎯', title: 'Francotirador de Prompts',
      description: 'Consigue 85% o más de precisión en Prompt Hunter',
      category: 'robotics', trigger: 'prompt-hunter-score', goal: 85
    },
    {
      id: 'robotics-graduate',
      icon: '🎓', title: 'Graduado en Robótica',
      description: 'Desbloquea los 4 robots: Excavador, TriceraBot, Raptor Scout y PteroDrone',
      category: 'robotics', trigger: 'all-robots-unlocked', goal: 4
    },
    {
      id: 'computational-thinker',
      icon: '🧠', title: 'Pensamiento Computacional',
      description: 'Completa todas las misiones de la expansión AI & Robotics Lab',
      category: 'robotics', trigger: 'mission-complete', goal: 14
    }
  ],
