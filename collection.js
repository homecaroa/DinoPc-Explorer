...
const Collection = {
  ...
  data: {
    ...
    // ── AI & Robotics Lab — Robots coleccionables ────
    excavador_mk1: {
      id:      'excavador_mk1',
      name:    'ExcavadorMK-I',
      emoji:   '🤖',
      cardImg: 'assets/images/excavador_mk1_card.svg',
      weight:  '850 kg (chasis reforzado)',
      size:    '1.4 metros',
      diet:    'Energía solar + batería',
      period:  'Generación Robótica I',
      fact:    'El primer robot del laboratorio. Diseñado para tareas de excavación y transporte siguiendo instrucciones básicas: AVANZAR, GIRAR, RECOGER.',
      color:   '#00cc88'
    },
    tricera_bot: {
      id:      'tricera_bot',
      name:    'TriceraBot',
      emoji:   '🦾',
      cardImg: 'assets/images/tricera_bot_card.svg',
      weight:  '1200 kg',
      size:    '2.1 metros',
      diet:    'Energía cinética',
      period:  'Generación Robótica II',
      fact:    'Especializado en diagnóstico de sistemas. Su triple sensor frontal (inspirado en el Triceratops) detecta errores de programación al instante.',
      color:   '#ff4422'
    },
    raptor_scout: {
      id:      'raptor_scout',
      name:    'Raptor Scout',
      emoji:   '🐾',
      cardImg: 'assets/images/raptor_scout_card.svg',
      weight:  '180 kg (ultraligero)',
      size:    '0.9 metros',
      diet:    'Microbatería de alta densidad',
      period:  'Generación Robótica III',
      fact:    'El robot más rápido del laboratorio. Ejecuta reglas de automatización SI/ENTONCES en milisegundos, clasificando objetos sin intervención humana.',
      color:   '#ff8800'
    },
    ptero_drone: {
      id:      'ptero_drone',
      name:    'PteroDrone',
      emoji:   '🛸',
      cardImg: 'assets/images/ptero_drone_card.svg',
      weight:  '45 kg',
      size:    '2.4 metros (envergadura)',
      diet:    'Paneles solares en las alas',
      period:  'Generación Robótica IV — Final',
      fact:    'El robot más avanzado de la colección. Comprende instrucciones complejas y es capaz de evaluar la precisión del lenguaje humano. ¡La cúspide de la expansión!',
      color:   '#4488ff'
    }
  },
