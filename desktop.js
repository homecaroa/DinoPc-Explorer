...
const Desktop = {
  ...
  templates: {
    ...
    'robotlab':    { title: '🤖 Lab de Robots',       w: 720, h: 500, init: () => RobotLab.init()      },
    'debugger':    { title: '🐛 Debugging Lab',       w: 680, h: 480, init: () => DebuggerLab.init()   },
    'automation':  { title: '⚙️ Automation Lab',      w: 700, h: 520, init: () => AutomationLab.init() },
    'prompthunter':{ title: '🎯 Prompt Hunter',        w: 560, h: 480, init: () => PromptHunter.init()  }
  },
  ...
  _buildContent(id) {
    switch (id) {
      ...
      case 'robotlab':      return RobotLab.buildHTML();
      case 'debugger':      return DebuggerLab.buildHTML();
      case 'automation':    return AutomationLab.buildHTML();
      case 'prompthunter':  return PromptHunter.buildHTML();
