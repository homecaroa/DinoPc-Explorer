 ...
 * Misión 14 — PteroDrone (misión final de la expansión)
 */
  ...
  CHALLENGES: [
    {
      ...
      options: [
        { text:'AVANZAR, AVANZAR, AVANZAR, RECOGER, AVANZAR, AVANZAR, SOLTAR', score:100, feedback:'✅ ¡Perfecto! Secuencia exacta y completa.' },
        { text:'AVANZAR muchas veces y luego RECOGER', score:20, feedback:'❌ Demasiado impreciso. Los robots necesitan instrucciones exactas.' },
        { text:'AVANZAR×3, RECOGER, AVANZAR×2, SOLTAR', score:90, feedback:'✅ Muy bien. La notación ×N es equivalente a REPETIR.' },
        { text:'Ir hacia el norte, coger cosa, llevar a caja', score:5, feedback:'❌ Los robots no entienden lenguaje natural vago.' }
      ],
      best: 0
    },
    {
      ...
      options: [
        ...
        { text:'REPETIR 4 AVANZAR', score:100, feedback:'✅ ¡Perfecto! REPETIR es más eficiente y claro.' },
        { text:'REPETIR 3 AVANZAR', score:20, feedback:'❌ Solo inspecciona 3 casillas, te falta una.' },
        { text:'AVANZAR hasta el final', score:0, feedback:'❌ "Hasta el final" no es una instrucción válida — sin límite definido.' }
      ],
      best: 1
    },
    {
      ...
      options: [
        { text:'RECOGER todo lo que encuentre', score:10, feedback:'❌ Recogerá también rocas. Necesitas una condición.' },
        { text:'SI hay_fosil → RECOGER', score:100, feedback:'✅ ¡Exacto! La condición SI filtra correctamente.' },
        { text:'SI hay_roca → RECOGER', score:0, feedback:'❌ ¡Al revés! Esto recogería las rocas, no los fósiles.' },
        { text:'AVANZAR y luego decidir', score:5, feedback:'❌ "Decidir" no es una instrucción. Debe ser explícito.' }
      ],
      best: 1
    },
    {
      ...
      options: [
        { text:'El robot no llega. Hay que arreglarlo.', score:10, feedback:'❌ Demasiado vago. No identifica el tipo de error.' },
        { text:'El número del REPETIR es incorrecto: dice 2 pero debe ser 5.', score:100, feedback:'✅ ¡Diagnóstico preciso! Indica exactamente dónde y qué está mal.' },
        { text:'Falta un AVANZAR al final.', score:30, feedback:'⚠️ Parcialmente correcto pero no identifica el REPETIR como causa.' },
        { text:'El programa está roto.', score:0, feedback:'❌ No aporta información útil para corregirlo.' }
      ],
      best: 1
    },
    {
      ...
      options: [
        { text:'SI fósil es grande → almacén especial', score:20, feedback:'❌ "Grande" es subjetivo. Necesitas un número concreto.' },
        { text:'SI peso > 5000 → almacén_pesado', score:100, feedback:'✅ ¡Perfecto! Condición numérica precisa con umbral definido.' },
        { text:'SI peso = 5000 → almacén_pesado', score:50, feedback:'⚠️ Casi, pero = solo aplica a exactamente 5000, no a más de 5000.' },
        { text:'Mover los pesados al especial', score:5, feedback:'❌ Sin formato SI/ENTONCES y sin valor numérico definido.' }
      ],
      best: 1
    }
  ],
  ...
  buildHTML() {
    ...
    <div class="ph-wrap" id="ph-wrap">
      <div class="ph-header">
        ...
        <div class="ph-progress" id="ph-progress">0 / ${this.CHALLENGES.length}</div>
    ...
    el.innerHTML = `
      ...
      <div class="ph-options" id="ph-options">
        ${ch.options.map((opt, i) =>
          `<button class="ph-option" id="ph-opt-${i}"
                   onclick="PromptHunter.answer(${i})">
      ...
      <button class="btn-primary ph-next hidden" id="ph-next"
              onclick="PromptHunter.next()">
