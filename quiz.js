  ...
  BANKS: {
    ...
    excavador_mk1: [
      { type:'concept',
        ...
        opts:['Una secuencia de pasos ordenados para resolver un problema','Un tipo de robot especial','Un lenguaje de programación','Una base de datos'],
        ans:0,
        fact:'Un algoritmo es como una receta: pasos ordenados que, seguidos correctamente, resuelven un problema. ¡Los robots ejecutan algoritmos!' },
      { type:'math', operation:'multiplication',
        q:'Un robot ejecuta 3 instrucciones por segundo. ¿Cuántas ejecuta en 8 segundos?',
        opts:['11','24','21','16'], ans:1, hint:'3 × 8 = ?',
        fact:'¡Correcto! 3 × 8 = 24. Los ordenadores reales ejecutan millones de instrucciones por segundo.' },
      { type:'concept',
        q:'¿Para qué sirve la instrucción REPETIR en programación?',
        opts:['Ejecutar el mismo bloque varias veces sin escribirlo repetido','Volver al principio siempre','Pausar el programa','Borrar instrucciones'],
        ans:0,
        fact:'REPETIR (o bucle/loop) evita escribir lo mismo muchas veces. Es uno de los conceptos más importantes en programación.' }
    ],

    tricera_bot: [
      { type:'concept',
        q:'¿Qué es un bug en programación?',
        opts:['Un error en el código que causa comportamiento incorrecto','Un insecto real en el ordenador','Un tipo de bucle','Una instrucción especial'],
        ans:0,
        fact:'El término "bug" viene de 1947 cuando una polilla real causó un fallo en una computadora. ¡Ahora llamamos así a todos los errores de código!' },
      { type:'math', operation:'subtraction',
        q:'Un programa tiene 15 instrucciones. Al hacer debugging encuentras 4 errores. ¿Cuántas son correctas?',
        opts:['10','11','12','9'], ans:1, hint:'15 − 4 = ?',
        fact:'15 − 4 = 11 instrucciones correctas. El debugging mejora la calidad del código corrigiendo errores uno a uno.' },
      { type:'concept',
        q:'¿Qué significa "depurar" un programa?',
        opts:['Encontrar y corregir errores en el código','Borrar el programa completo','Hacerlo más rápido','Cambiar de lenguaje'],
        ans:0,
        fact:'Depurar (debug) es el proceso de encontrar y corregir errores. ¡Los mejores programadores son también excelentes depuradores!' }
    ],

    raptor_scout: [
      { type:'concept',
        q:'¿Qué es la automatización en informática?',
        opts:['Usar reglas para que el sistema decida sin intervención humana','Hacer las cosas más despacio','Necesitar más personas','Solo copiar archivos'],
        ans:0,
        fact:'La automatización permite que los sistemas realicen tareas repetitivas con reglas, liberando a las personas para trabajo más creativo.' },
      { type:'math', operation:'division',
        q:'Un sistema automático clasifica 120 fósiles en 4 horas iguales. ¿Cuántos fósiles por hora?',
        opts:['25','30','35','20'], ans:1, hint:'120 ÷ 4 = ?',
        fact:'120 ÷ 4 = 30 fósiles/hora. La automatización acelera procesos repetitivos de forma constante y sin errores.' },
      { type:'concept',
        q:'En una regla SI condición ENTONCES acción, ¿qué pasa si la condición es falsa?',
        opts:['No se ejecuta la acción','Se ejecuta de todas formas','El programa se detiene','Se repite la condición'],
        ans:0,
        fact:'La acción SOLO ocurre cuando la condición es verdadera. Así los sistemas toman decisiones inteligentes automáticamente.' }
    ],

    ptero_drone: [
      { type:'concept',
        q:'¿Por qué es importante ser preciso al escribir instrucciones para un robot?',
        opts:['Los robots hacen exactamente lo que se les dice, sin interpretar','Son muy listos y entienden todo','Adivinan lo que queremos','Les da igual la precisión'],
        ans:0,
        fact:'Los ordenadores son literales: hacen exactamente lo que se les pide. La precisión es la diferencia entre un programa que funciona y uno que falla.' },
      { type:'math', operation:'percentage',
        q:'De 5 instrucciones dadas a un robot, 4 son precisas. ¿Qué porcentaje de precisión tiene?',
        opts:['70%','75%','80%','85%'], ans:2, hint:'(4 ÷ 5) × 100 = ?',
        fact:'(4 ÷ 5) × 100 = 80% de precisión. En programación se busca el 100%: cada instrucción debe ser exacta.' },
      { type:'concept',
        q:'¿Qué diferencia hay entre "avanzar mucho" y "REPETIR 5 AVANZAR" como instrucción de robot?',
        opts:['"REPETIR 5 AVANZAR" es precisa y ejecutable; "avanzar mucho" es vaga e inútil para un robot','Son equivalentes','La primera es mejor siempre','Depende del robot'],
        ans:0,
        fact:'Los robots necesitan instrucciones cuantificadas. "REPETIR 5" es exacto y predecible. "Mucho" no tiene valor numérico y el robot no puede procesarlo.' }
    ]
